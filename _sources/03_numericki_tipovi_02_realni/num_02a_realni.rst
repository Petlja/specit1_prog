...
.. infonote::
    ...
    Један податак типа ``double`` заузима 8 бајтова, а садржи 16 до 17 значајних цифара. Рачунарска меморија је током низа година постајала све јефтинија и доступнија у великим количинама, па је тип ``double`` временом постао тип опште намене, што значи да је он најчешће у употреби у разним проблемима у којима се користе реални бројеви. Због тога ћемо ми скоро искључиво користити овај тип за представљање реалних бројева.

    Тип ``decimal`` заузима чак 16 бајтова за један податак и садржи 28 до 29 значајних цифара. Типична употреба овог типа је у финансијским израчунавањима, јер је овај тип додатно прилагођен да се избегну грешке заокруживања, какве нису допуштене у рачунању са новцем. 
...
Ако још нисте, проучите примере записивања израза дате у приручнику. Нарочито обратите пажњу на то да су при записивању неких израза у програмима неопходне заграде иако у математичком запису тих израза нема заграда. На пример:
