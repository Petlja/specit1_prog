...
.. csv-table:: Исправност конструкција програмског језика
    ...
    ``+ * 3 5 = a``,            да, не, --, "Ова конструкција је лексички исправна јер садржи само дозвољене знакове. Међутим, редослед знакова не одговара ниједном правилу формирања језичких конструкција (не постоји наредба са оваквом структуром). Зато је овај запис синтаксно несиправан."
