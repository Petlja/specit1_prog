...
project = 'Петља - Програмирање за први разред - смер рачунарство'
...
html_context = {'course_id': 'Програмирање за први разред - смер рачунарство',
                ...
                'basecourse': 'Програмирање за први разред - смер разунарство',
...
html_theme_options = {
    ...
    'navbar_title': "Петља - Програмирање за први разред - смер рачунарство",
