...
scenario = '21_niz_alokacija'

subtitles = []
subtitles.append(u'Програм учитава вредност променљиве $n$ са тастатуре, унесимо нпр. 5.')    # 1
subtitles.append(u'У динамичкој меморији (на хипу) ћемо заузети простор за 5 целих бројева.') # 2 
subtitles.append(u'Простор је алоциран и низ је формиран, $a$ добија адресу тог простора.')   # 3
